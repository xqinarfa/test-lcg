...
- Use `find_ui_materials` only for a named font, icon, motion, or interaction role the local system does not already solve. Keep included and external license status distinct.
